							...
							<div class="row">
								...
								<div class="col-md-3 bg-success mx-2 " style="height: 130px; ">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<a href="admin.php"><i class="fa fa-user-shield fa-3x my-4" style="color: white;"></i></a>
										</div>
								...
								<div class="col-md-3 bg-danger mx-2 my-3" style="height: 130px;">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<a href="#"><i class="fa fa-globe-americas fa-3x my-4" style="color: white;"></i></a>
										</div>
								...
								<div class="col-md-3 bg-warning mx-2 my-3" style="height: 130px;">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<a href="#"><i class="fa fa-envelope-open-text fa-3x my-4" style="color: white;"></i></a>
										</div>
