	 						...
	 						<div class="row">
	 							<div class="col-md-6">
	 								...
	 								<form method="post" enctype="multipart/form-data">
	 									<?php 
	 										...
	 										echo "<img src='img/$profiles' class='col-md-12' style='height: 400px;'>";
	 							...
	 							<div class="col-md-6">
	 								...
	 								<form method="post">
	 									...
	 									<input type="text" name="uname" class="form-control" autocomplete="off" placeholder="Type new Admin Name">

	 									<input type="submit" name="change" class="btn btn-success" value="Change" style="margin-top: 5px;">
	 									...
	 									<form method="post">
	 										...
	 										<input type="submit" name="update pass" value="Update Password" class="btn btn-info">
